...
// Then display the player’s choice, the opponent’s choice, and the result of the match.
//Continue until the user doesn’t want to play anymore.
//If the user makes an invalid selection.
//Display an appropriate error message and prompt the user again until the user makes a valid selection.
